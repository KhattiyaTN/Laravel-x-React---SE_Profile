...
export default function BadgeFormIndex() {
    ...
    return (
        ...
        >
            <Head title="Softskill create" />

            <div className="flex min-h-screen flex-col justify-center items-center">
                <div className="w-full overflow-hidden px-6 py-4 -mt-44 shadow-md sm:max-w-md sm:rounded-lg bg-card shadow-primary">
