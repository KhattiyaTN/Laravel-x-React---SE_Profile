...
export default function BadgeFormIndex() {
    ...
    return (
        ...
        >
            <Head title="Certificate create" />

            <div className="flex min-h-screen flex-col justify-center items-center">
                <div className="w-full overflow-hidden px-6 py-4 -mt-28 shadow-md sm:max-w-md sm:rounded-lg bg-card shadow-primary">
                    <form onSubmit={handleSubmit} className="flex-row space-y-3">
                        ...
                        {/* ออกโดย */}
                        <div>
                            <InputLabel htmlFor="issued_by" value="" />
                            <TextInput
                                id="issued_by"
                                type="text"
                                name="issued_by"
                            ...
                            />
                            <InputError message={errors.issued_by} className="mt-2 text-primary" />
                        </div>
                        {/* วันที่ */}
                        <div>
